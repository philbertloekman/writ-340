...
\begin{document}
    ...
    \section{Solutions}
        ...
        Agencies should be required to implement staged, milestone-based funding structures for all major capital projects. Rather than releasing budgets in a single upfront authorization, funding would be disbursed in defined phases, each tied to the verified completion of specific, measurable milestones such as completion of environmental review, finalization of design documents, utility relocation, or the end of a defined construction phase. There is strong evidence from the venture capital industry that this approach works to align how money is dispersed from investors with startup company productivity, similar to the payment structure between a public infrastructure program and construction contractors \cite{n10}. This is because milestone-based financing connects funding to real progress rather than 1 large upfront payment \cite{n10}.

        To advance to each subsequent phase, an independent review, outside of LA Metro's Office of Inspector General, would verify that the previous phase was completed on time and within its approved budget. Independent reviewers can be a state auditor, a rotating panel of outside engineers, or a federal oversight body. If a milestone is missed by a set amount of time or cost, the next funding round would be withheld until a remediation plan is reviewed and approved. For projects with very high budgets or tight construction timelines like that of the LAX APM, there is also potential to introduce modest incentive payments for early completion or penalties for significant delays and lack of action to resolve them. Furthermore, to prevent depreciation of the withheld funds due to inflation, the public funds can be invested in treasury securities, money market funds, and agency securities. This structure distributes accountability throughout a project's execution and lowers financial risk for LA Metro, contractors, and the public.

        In practice, every LA Metro project over a set cost threshold should be planned with a defined milestone schedule before voter or board approval. This schedule would specify construction phases, expected completion dates, phase budgets, and verification standards. Both the schedule and the results of each phase review would be made public, giving residents and policymakers transparent, regular checkpoints throughout the project's timeline.
