...
\begin{document}
    ...
    \newpage
        ...
        \subsection{Appendix A: \LaTeX{} Deliverables (CSCI 401, Deliverables 1 through 4)}
            ...
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_1.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_2.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_3.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_4.png}
            \end{tabular}\end{figure}\clearpage

            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_5.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_6.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_7.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-1/Deliverable 1_8.png}
            \end{tabular}\end{figure}\clearpage
            ...
            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_1.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_2.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_3.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_4.png}
            \end{tabular}\end{figure}\clearpage

            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_5.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_6.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-2/Deliverable 2_7.png} &
            \end{tabular}\end{figure}\clearpage
            ...
            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_1.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_2.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_3.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_4.png}
            \end{tabular}\end{figure}\clearpage

            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_5.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_6.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_7.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_8.png}
            \end{tabular}\end{figure}\clearpage

            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_9.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_10.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_11.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_12.png}
            \end{tabular}\end{figure}\clearpage

            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{p{0.44\textwidth}p{0.44\textwidth}}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-3/Deliverable 3_13.png} &
            \end{tabular}\end{figure}\clearpage
            ...
            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_1.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_2.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_3.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_4.png}
            \end{tabular}\end{figure}\clearpage

            \begin{figure}[H]\centering\setlength{\tabcolsep}{4pt}
            \begin{tabular}{cc}
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_5.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_6.png} \\[4pt]
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_7.png} &
            \includegraphics[width=0.44\textwidth,height=0.44\textheight,keepaspectratio]{images/deliverables/deliverable-4/Deliverable 4_8.png}
            \end{tabular}\end{figure}\clearpage
